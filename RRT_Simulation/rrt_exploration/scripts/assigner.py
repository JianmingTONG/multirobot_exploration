...
def node():
	global centroids, mapData, global1, global2, global3, globalmaps
...
#-------------------------------------------
	...
	rospy.Subscriber(centroids_topic, PointArray, callBack)
...
#-------------------------------------------------------------------------            
		...
		centroid_record=[]
		id_record=[]
		rospy.loginfo("receive %d point"%len(centroids))
		for ir in na:

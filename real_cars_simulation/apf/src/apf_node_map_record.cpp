...
int main(int argc, char** argv) {
    ...
    int rateHz;
    ros::init(argc, argv, "apf_node_map_record");
    ros::NodeHandle nh;
    ...
    while(ros::ok()){
        ...
        while(iteration < 2000 && minDis2Frontier > 1){
            std::ofstream ofile_map;
            ofile_map.open("/home/jimmy/work/ROS_work/multirobot_github_ws/src/apf/output_map2.txt");
#ifdef FILE_DEBUG
            ...
            // ------------------------------------------ get the minimial potential of the points around currentLoc
            {
                ...
                for (int i = 0; i < loc_around.size(); i++){
                    ...
                    std::ofstream ofile_int;
                    ofile_int.open("/home/jimmy/work/ROS_work/multirobot_github_ws/src/apf/output_dismap2.txt");
#ifdef FILE_DEBUG
